...
class TicTacToeManager:
    ...
    help_message = (
        ...
        "'tictactoe' or 'ttt'\n"
        "To start a game agaisnt Zac, type start as the second word, "
        ...
        "To have Zac play himself, type self instead of start")
    ...
    def get_message(self, channel, message, user):
        ...
        if len(players) > 2:
            self.msg_writer.send_message(
                channel, "You may not have more than two players currently"
            )
            return
