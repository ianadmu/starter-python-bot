...
class SlackClients(object):
    ...
    def send_time_triggered_msg2(self, channel_name, msg):
    	self.rtm.api_call('chat.postMessage', as_user='true:', channel=channel_name, command='/shrug', text="{}".format(msg.encode('ascii', 'ignore')))
